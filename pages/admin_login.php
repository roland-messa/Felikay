...
// 1. CRÉATION DE L'EMPREINTE (Porte de session invisible)
$_SESSION['admin_access_gate'] = true;
$_SESSION['admin_access_ip'] = $_SERVER['REMOTE_ADDR'];
$_SESSION['admin_user_agent'] = $_SERVER['HTTP_USER_AGENT'];

// 2. GÉNÉRATION DU TOKEN CSRF (Usage unique pour le formulaire)
$_SESSION['csrf_token'] = bin2hex(random_bytes(32));

// 3. VÉRIFICATION DU BLOCAGE (Si trop de tentatives échouées)
if (isset($_SESSION['blocked_until']) && $_SESSION['blocked_until'] > time()) {
  $seconds_left = $_SESSION['blocked_until'] - time();
  die("Sécurité : Trop d'échecs. Accès bloqué pendant encore $seconds_left secondes.");
}
