  ...
  <div class="max-w-[1200px] mx-auto px-6">
    <div class="grid md:grid-cols-3 gap-16">
      ...
      <div class="space-y-12" data-aos="fade-right">
        ...
        <div class="space-y-6">
          <div>
            <span class="text-[9px] uppercase tracking-[0.3em] font-bold text-stone-400 block mb-2">Showroom</span>
          ...
          <div>
            ...
            <p class="text-sm tracking-widest">concierge@felikay.com</p>
          </div>
        </div>
      </div>

      <div class="md:col-span-2 bg-white p-10 md:p-16 shadow-sm border border-stone-100" data-aos="fade-up">
        <form action="../actions/contact_process.php" method="POST" class="space-y-8">
          <div class="grid md:grid-cols-2 gap-8">
            ...
            <div class="space-y-2">
              <label class="text-[9px] uppercase tracking-widest font-bold">Votre Email</label>
              <input type="email" name="email" required class="w-full border-b border-stone-200 py-3 text-sm outline-none focus:border-black transition bg-transparent">
            </div>
          </div>
          <div class="space-y-2">
