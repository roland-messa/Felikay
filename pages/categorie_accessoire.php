            ...
            ?>
              <div class="product-card group">
                ...
                <div class="text-center">
                  <h3 class="text-[11px] uppercase tracking-[0.2em] font-medium mb-2"><?php echo $article['nom']; ?></h3>
                  <p class="font-serif italic text-stone-500 text-[14px]"><?php echo number_format($article['prix'], 2); ?> <?php echo $article['devise']; ?></p>
                </div>
              </div>
            <?php endforeach; ?>
          </div>
